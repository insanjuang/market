        ...
        <div class="container">
            <div class="toolbox">
                ...
                <div class="toolbox-center">
                    <div class="toolbox-info">
                        Menampilkan <span>{{(($products->currentPage()-1)*$products->perPage())+$products->count()}} dari {{$products->total()}}</span> Produk
            ...
            <div class="products">
                        ...
                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <a href="{{route('store.productDetail',$product->id_produk)}}">
                ...
                <div class="load-more-container text-center">
                    ...
                    <a href="{{$products->previousPageUrl()}}" class="btn btn-outline-darker btn-load-more disabled"><i
                            class="icon-arrow-left"></i> Sebelumnya</a>
                    @else
                    <a href="{{$products->previousPageUrl()}}" class="btn btn-outline-darker btn-load-more"><i
                            class="icon-arrow-left"></i> Sebelumnya</a>
                    @endif
                    @if ($products->onLastPage())
                    <a href="{{$products->nextPageUrl()}}" class="btn btn-outline-darker btn-load-more disabled">Selanjutya <i
                            class="icon-arrow-right"></i></a>
                    @else
                    <a href="{{$products->nextPageUrl()}}" class="btn btn-outline-darker btn-load-more">Selanjutnya <i
                            class="icon-arrow-right"></i></a>
                    @endif
