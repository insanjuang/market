<?php $page="editpurchase";?>
@extends('layout.mainlayout')
@section('content')
<div class="page-wrapper">
    <div class="content">
        @component('components.pageheader')
			@slot('title') Purchase Edit @endslot
			@slot('title_1') Edit/Update Purchase @endslot
		@endcomponent
        <div class="card">
            <div class="card-body">
                <div class="row">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Discount(Rp)</th>
                                    <th class="text-end">Unit Cost(Rp)</th>
                                    <th class="text-end">Total Cost(Rp)</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
