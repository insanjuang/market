  ...
  <div class="sidebar new-header">
    ...
    @endif
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="nav">
                <li class="submenu">
                    <a href="#" ><img src="{{ URL::asset('/assets/img/icons/menu-icon.svg')}}" alt="img"><span> Main Menu</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="{{ route('dashboard') }}" ><img src="{{ URL::asset('/assets/img/icons/dashboard.svg')}}" alt="img"><span> Dashboard</span> </a></li>
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('products/category')}}">Category List</a></li>
                                <li><a href="{{route('products/subcategory')}}">Sub Category List</a></li>
                                <li><a href="importproduct">Import Products</a></li>
                                <li><a href="barcode">Print Barcode</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/icons/users1.svg')}}" alt="img"><span> Entities</span> <span class="menu-arrow"></span></a>
                            <ul>
...
@endif
    <div class="sidebar-inner slimscroll">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <div class="tab-content tab-content-four pt-2">
                <ul class="tab-pane active" id="home" aria-labelledby="home-tab">
                    <li><a href="{{ route('dashboard') }}" ><span> Dashboard</span> </a></li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><span> Entities</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{route('supplier.index')}}">Supplier List</a></li>
                                <li><a href="customerlist">Customer List</a></li>
                                <li><a href="storelist">Store List</a></li>
            ...
            <ul>
                <li>
                    <a class="{{ Request::is('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}" ><img src="{{ URL::asset('/assets/img/icons/dashboard.svg')}}" alt="img"><span> Dashboard</span> </a>
                </li>
                <li class="submenu">
                    <a class="{{ Request::is('products') ? 'active' : '' }} href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/icons/product.svg')}}" alt="img"><span> Product</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a class="{{ Request::is('products/product') ? 'active' : '' }}" href="{{route('product.index')}}">Product List</a></li>
                        <li><a class="{{ Request::is('products/category') ? 'active' : '' }}"href="{{url('products/category')}}">Category List</a></li>
                        <li><a class="{{ Request::is('products/subcategory') ? 'active' : '' }}"href="{{url('products/subcategory')}}">Sub Category List</a></li>
                        <li><a class="{{ Request::is('products/importproduct') ? 'active' : '' }}"href="#">Import Products</a></li>
                        <li><a class="{{ Request::is('products/barcode') ? 'active' : '' }}"href="#">Print Barcode</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    <a class="{{ Request::is('entities') ? 'active' : '' }}" href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/icons/users1.svg')}}" alt="img"><span> Entities</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a class="{{ Request::is('entities/supplier') ? 'active' : '' }}" href="{{route('supplier.index')}}">Supplier List</a></li>
                ...
                <li class="submenu">
                    <a class="{{ Request::is('transaction') ? 'active' : '' }}" href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/icons/purchase1.svg')}}" alt="img"><span> Purchase</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a class="{{ Request::is('transaction/purchase') ? 'active' : '' }}" href="{{route('purchase.index')}}">Purchase List</a></li>
            ...
            <ul>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="{{ route('dashboard') }}" class="active"><img src="{{ URL::asset('/assets/img/icons/dashboard.svg')}}" alt="img"><span> Dashboard</span> </a></li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/icons/product.svg')}}" alt="img"><span> Product</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ route('product.index') }}">Product List</a></li>
