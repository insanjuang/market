				...
				<div class="profilename">
					<div class="profileset">
						...
						<div class="profilesets">
							...
							<h5>{{(auth()->user()->level == 1)? "Administrator" : "Cashier"}}</h5>
						</div>
					</div>
					<hr class="m-0">
					...
					<hr class="m-0">
					<a class="dropdown-item logout pb-0" href="#" onclick="$('#logout-form').submit()"><img src="{{ URL::asset('/assets/img/icons/log-out.svg')}}" class="me-2" alt="img">Logout</a>
				</div>
			</div>
		</li>
	</ul>
