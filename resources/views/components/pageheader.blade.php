<div class="page-header">
    ...
    @endif
    @if(Route::is(['subcategory.index']))
    <div class="page-btn">
        <a href="{{route('subcategory.create')}}" class="btn btn-added">
            <img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-2">Add SubCategory
        </a>
    </div>
    @endif
    @if(Route::is(['product.index']))
    <div class="page-btn">
        <a href="{{route('product.create')}}" class="btn btn-added"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add New Product</a>
    </div>
    @endif
    @if(Route::is(['supplier.index']))
    <div class="page-btn">
        <a href="{{route('supplier.create')}}" class="btn btn-added"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img">Add Supplier</a>
    </div>
    @endif
