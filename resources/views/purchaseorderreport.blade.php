<?php $page="purchaseorderreport";?>
@extends('layout.mainlayout')
@section('content')
<div class="page-wrapper">
    <div class="content">
        @component('components.pageheader')                
			@slot('title') Purchase order report @endslot
			@slot('title_1') Manage your Purchase order report @endslot
		@endcomponent
        <!-- /product list -->
        <div class="card">
            <div class="card-body">
                    ...
                    <table class="table datanew">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img">
                                        <img src="{{ URL::asset('/assets/img/product/product9.jpg')}}" alt="product">
                                    </a>
