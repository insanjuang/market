  ...
  .btn-secondary {
    ...
    .btn-secondary:focus, .btn-secondary.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(54, 67, 116, 0.5);
              box-shadow: 0 0 0 0.2rem rgba(54, 67, 116, 0.5); }
  ...
  .btn-light {
    ...
    .btn-light:focus, .btn-light.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(222, 210, 201, 0.5);
              box-shadow: 0 0 0 0.2rem rgba(222, 210, 201, 0.5); }
  ...
  .btn-gray {
    ...
    .btn-gray:focus, .btn-gray.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(211, 212, 216, 0.5);
  ...
  .btn-outline-secondary {
    ...
    .btn-outline-secondary:focus, .btn-outline-secondary.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(18, 34, 91, 0.5);
              box-shadow: 0 0 0 0.2rem rgba(18, 34, 91, 0.5); }
  ...
  .btn-outline-light {
    ...
    .btn-outline-light:focus, .btn-outline-light.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(255, 240, 229, 0.5);
              box-shadow: 0 0 0 0.2rem rgba(255, 240, 229, 0.5); }
  ...
  .btn-outline-primary-light {
    ...
    .btn-outline-primary-light:focus, .btn-outline-primary-light.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(255, 136, 51, 0.5);
  ...
  .btn-outline-gray {
    ...
    .btn-outline-gray:focus, .btn-outline-gray.focus {
      -webkit-box-shadow: 0 0 0 0.2rem rgba(242, 243, 247, 0.5);
